...
port = 5556  # Unique port for each node
self_address = "tcp://*:" + str(port)  # Use wildcard address to bind to all available interfaces
...
socket_receive.connect("tcp://localhost:5555")
