...
// void expandCluster(int pointIndex, int clusterId, std::vector<int> &neighbors)
// {
//     std::vector<int> searchQueue = neighbors; // Initialize with the first set of neighbors
//     int currentIndex = 0;

//     while (currentIndex < searchQueue.size())
//     {
//         int currentPointIndex = searchQueue[currentIndex++];

//         if (points[currentPointIndex].clusterId == UNCLASSIFIED || points[currentPointIndex].clusterId == NOISE)
//         {
//             points[currentPointIndex].clusterId = clusterId;
//             std::vector<int> currentNeighbors;
//             getNeighbors(currentPointIndex, currentNeighbors);

//             if (currentNeighbors.size() >= minPoints)
//             {
//                 for (int neighborIndex : currentNeighbors)
//                 {
//                     if (std::find(searchQueue.begin(), searchQueue.end(), neighborIndex) == searchQueue.end())
//                     {
//                         searchQueue.push_back(neighborIndex);
//                     }
//                 }
//             }
//         }
...
// Function to find neighbors of a point with a hybrid approach
// void getNeighbors(int pointIndex, std::vector<int> &neighbors)
// {
//     neighbors.clear();
//     for (int i = 0; i < numPoints; ++i)
//     {
//         if (i != pointIndex && calculateDistance(points[pointIndex], points[i]) <= epsilon)
//         {
